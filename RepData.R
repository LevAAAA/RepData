...
activity_by_date_weekday <- subset(activity_by_date_week, activity_by_date_week$typeday=="weekday")
activity_by_date_weekend <- subset(activity_by_date_week, activity_by_date_week$typeday=="weekend")
